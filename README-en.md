...
We have open sourced part of the data set. You can visit this [link](https://huggingface.co/datasets/ShengbinYue/DISC-Law-SFT) to download the data set.
...
|  Model   ↓  Eval On →  | FinFE (Accuracy) | FinQA (F1) | FinCQA (F1) | FinNA (ROUGE) | FinRE (F1) | FinESE (F1) | 平均值 |
|:-----------------:|:----------------:|:----------:|:-----------:|:-------------:|:----------:|:-----------:|:------:|
